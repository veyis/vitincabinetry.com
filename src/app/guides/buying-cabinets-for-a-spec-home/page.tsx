...
const SLUG = "buying-cabinets-for-a-spec-home";
...
export default function BuyingCabinetsSpecHomePage() {
      ...
      <section className="subhero">
        <div className="container--narrow">
          <nav className="breadcrumb" aria-label="Breadcrumb">
            ...
            <span className="sep">/</span>
            <span aria-current="page">Buying Cabinets for a Spec Home</span>
          </nav>
